...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "IIVS"."TIIVS_SOLICITUD_AGRUPACIO_PK" ON "IIVS"."TIIVS_SOLICITUD_AGRUPACION" ("COD_AGRUP") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "IIVS"."TIIVS_SOLICITUD_AGRUPACION" ADD CONSTRAINT "TIIVS_SOLICITUD_AGRUPACIO_PK" PRIMARY KEY ("COD_AGRUP") ENABLE;
  ALTER TABLE "IIVS"."TIIVS_SOLICITUD_AGRUPACION" MODIFY ("COD_AGRUP" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "IIVS"."TIIVS_AGRUPACION_PERSONA" ADD CONSTRAINT "TIIVS_AGRUPACION_PERSONA__SOA" FOREIGN KEY ("COD_AGRUP")
	  REFERENCES "IIVS"."TIIVS_SOLICITUD_AGRUPACION" ("COD_AGRUP") ENABLE;
--------------------------------------------------------
